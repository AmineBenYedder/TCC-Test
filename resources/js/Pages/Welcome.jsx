                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <a
                                    href="https://www.tuniscallcenter.com"
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        <h2 className="text-xl font-semibold text-black dark:text-white">TEST TECHNIQUE TUNIS CALL CENTER</h2>

                                        <p className="mt-4 text-sm/relaxed">
                                           Cette application présente un test technique  Backend basé sur MySQL et Laravel version 11 et React JS coté Front-end.
                                        </p>
                                    </div>
